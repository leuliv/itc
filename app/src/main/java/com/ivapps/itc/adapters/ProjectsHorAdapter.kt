...
class ProjectsHorAdapter  internal constructor(
    private val context: Context
) :
    RecyclerView.Adapter<ProjectsHorAdapter.ViewHolder>() {

    private val mInflater: LayoutInflater = LayoutInflater.from(context)

    override fun onCreateViewHolder(parent: ViewGroup, p: Int): ViewHolder {
        val view = mInflater.inflate(R.layout.single_hor_project, parent, false)
